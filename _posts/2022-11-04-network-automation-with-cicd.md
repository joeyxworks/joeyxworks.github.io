...
![]({{ page.image1 | relative_url }}){:class="embed-image"}
...
![]({{ page.image2 | relative_url }}){:class="embed-image"}
...
![]({{ page.image3 | relative_url }}){:class="embed-image"}
...
![]({{ page.image4 | relative_url }}){:class="embed-image"}

![]({{ page.image5 | relative_url }}){:class="embed-image"}
